...
<title>K&N's Chapli Kabab Pizza Method</title>
  ...
  <body>
    <div class="container">
       ...
       <div class="col-md-12">
        ...
        <form class="form-horizontal" id="form-edit-client" method="post" action="process_method_pizza.php">
        <fieldset>

        <!-- Form Name -->
        <legend><center>Chapli Kabab Pizza Method</center></legend>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-4">
                            <a class="btn btn-default-btn-xs btn-success" href="ingredient_chapli_kabab_pizza.php"><i class="glyphicon glyphicon-chevron-left"></i>Previous</a>
